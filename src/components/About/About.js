        ...
        <Container className="mt-5">
            <Row className="g-4">
                ...
                <Col lg="8" className="pe-5">
                    ...
                    <p className="text-secondary my-5">In academic terms, a text is anything that conveys a set of meanings to the person who examines it. You might have thought that texts were limited to written materials, 
